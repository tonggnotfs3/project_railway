...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2018 at 01:51 PM
...
--
-- Database: `project_railway`
--

-- --------------------------------------------------------

--
-- Table structure for table `admireform`
--

CREATE TABLE `admireform` (
  `admire_id` int(10) NOT NULL,
  `name_admire` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `idcard_admire` varchar(14) COLLATE utf8_unicode_ci NOT NULL,
  `address_admire` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `province_id` int(10) NOT NULL,
  `districts_id` int(10) NOT NULL,
  `amphur_id` int(10) NOT NULL,
  `tel_admire` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `detail_admire` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `email_admire` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `status` int(10) NOT NULL,
  `responsible` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `admireform`
--

INSERT INTO `admireform` (`admire_id`, `name_admire`, `idcard_admire`, `address_admire`, `province_id`, `districts_id`, `amphur_id`, `tel_admire`, `detail_admire`, `email_admire`, `status`, `responsible`) VALUES
(1, 'frist', '1149900339514', '12', 1, 1, 1, '870792322', 'eiei', 'dsadsa@sdadsa.;com', 1, 1),
(2, '1', '1', '1', 1, 11, 1, '1', '1', '1', 1, 1),
(3, 'นันทวัฒน์ ศิริวรรณ', '1149900339514', '31', 5, 563, 84, '870792322', '            eiei', 'tongfs33@gmail.com', 0, 1),
(4, 'ชื่นชม', '1149900339514', '31', 1, 125, 19, '0870792322', '            ทดสอบบ', 'tong_fs3@outlook.com', 0, 1),
(5, 'dsa', '321321', '321321', 58, 7260, 808, '321321321', '            ', '3213213', 1, 1);
...
CREATE TABLE `complaintform` (
  `complaintform_id` int(10) NOT NULL,
  `complaint_name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `complaintform` (`complaintform_id`, `complaint_name`, `personal_id`, `address`, `province_id`, `districts_id`, `amphur_id`, `email`, `tel`, `complainttype_id`, `service_id`, `description`, `status`, `responsible`) VALUES
(10, 'นันทวัฒน์ ศิริวรรณ', '1149900339514', '31', 5, 84, 563, 'tong_fs3@outlook.com', '0870792322', 8, 31, '            นอนลำบาก', 2, 1),
(11, 'นันทวัฒน์ ศิริวรรณ', '1111', '31', 1, 18, 120, 'tdsa@outlook.com', '0870792322', 2, 9, '          dsadsa  ', 1, 1),
(12, 'test1', '1149900339514', '31', 58, 808, 7267, 'tong_fs3@outlook.com', '0870792322', 4, 15, '            08707707', 1, 1),
(13, 'ตองจ้า', '1111111', 'กหฟกหฟหฟหกฟ', 36, 558, 5039, '0080808@gmail.com', '0808080808', 2, 9, '          dsadsadsadsadsadsadsadsa  ', 1, 1),
(14, 'กหฟกหฟกหฟกหฟกหฟ', '123123132131', '31', 19, 229, 1969, 'tong_fs3@outlook.com', '080870707', 2, 9, '            dsadsadsadsa', 1, 0),
(15, 'dsadsa', '1149900339514', '31', 5, 84, 563, 'tong_fs3@outlook.com', '0870792322', 8, 31, '      dsadsadsadsa      ', 1, 1),
(16, 'dsadsadsadsa', '1149900339514', '3131', 50, 724, 6433, 'tongfs33@outlook.com', '0870792322', 4, 16, '            dsadsa', 1, 0),
(17, 'dsadsa', '1149900339514', '31', 36, 5002, 554, 'dsadsa@dsadsa.com', '0870792322', 2, 9, '            dsadsa', 2, 1),
(18, 'กหฟกหฟกหฟ', '1149900339514', '31', 5, 563, 84, 'tong@dsadas.com', '0870792322', 2, 9, '            dsadsadsa', 2, 1),
(19, 'test php7', '7777777777777', '7', 13, 1359, 169, '777@777.7', '0777777777', 8, 33, '        77777777    ', 2, 1),
(20, 'กหฟกหฟกหฟ', '11111', '11', 19, 2074, 243, 'tong_fs3@outlook.com', '0870707', 5, 17, '            dsadsa', 1, 2),
(21, 'new', '1149900339514', 'new', 1, 0, 2, 'new@new', '1', 2, 9, '         newnewnew   ', 1, 0),
(22, 'ทดลอง 1', '1149900339514', '31', 15, 1483, 183, 'tong@dsadas.com', '0870792322', 2, 9, '  dsadsadsa          ', 1, 2),
(23, 'อิอิเลย', '1234567891111', '31', 64, 7823, 867, 'tttt@rrrr.com', '0808080808', 2, 9, '              dsadsadsadsa', 0, 2),
(24, 'ohmylipz', '1149900339514', '31', 1, 201, 35, 'dsadsa@dsadsa.com', '080808808', 2, 9, '             dsadsadsadsadsadsadsadsadsa ', 1, 3),
(25, 'สิบ', '101010101010', '10', 9, 948, 120, 'ten@ten.com', '1010101010', 2, 7, '              10ten', 1, 1),
(26, 'dsadsa', '114990033951', 'dsa', 19, 2076, 243, 'dsadsa@dsadsa.com', '0870792322', 2, 8, '              dsadsadsadsa', 0, 1);
...
CREATE TABLE `complainttype` (
  `complainttype_id` int(10) NOT NULL,
  `complaint_code` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `complainttype` (`complainttype_id`, `complaint_code`) VALUES
(1, 'บริการ'),
(2, 'ขบวนรถ'),
(3, 'ที่ดิน'),
(4, 'ตั๋วโดยสาร'),
...
--
-- Table structure for table `dagerform`
--

CREATE TABLE `dagerform` (
  `name_dager` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `idcard` varchar(14) COLLATE utf8_unicode_ci NOT NULL,
  `address_dager` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `province_id` int(10) NOT NULL,
  `distrocts_id` int(10) NOT NULL,
  `amphur_id` int(10) NOT NULL,
  `tel_dager` int(10) NOT NULL,
  `detail_dager` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `dager_id` int(10) NOT NULL,
  `status` int(10) NOT NULL,
  `email_dager` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `responsible` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `dagerform`
--

INSERT INTO `dagerform` (`name_dager`, `idcard`, `address_dager`, `province_id`, `distrocts_id`, `amphur_id`, `tel_dager`, `detail_dager`, `dager_id`, `status`, `email_dager`, `responsible`) VALUES
('dsa', '14141414', '14', 1, 1, 1, 870792322, '12321321321321321321321', 1, 1, 'ewqewq@dsadsa.com', 1),
('dsadsa', '321321', '321', 64, 7823, 867, 321321321, '       dsadsa     ', 2, 1, 'dsadsa', 1),
('dsad', '1149900339514', '312', 58, 7260, 808, 321321, '         321   ', 3, 0, '321321', 1),
('dsad', '1149900339514', '312', 64, 7829, 867, 321321, '         321   ', 4, 1, '321321', 1);
...
INSERT INTO `districts` (`DISTRICT_ID`, `DISTRICT_CODE`, `DISTRICT_NAME`, `AMPHUR_ID`, `PROVINCE_ID`, `GEO_ID`) VALUES
...
CREATE TABLE `routetype` (
  `route_id` int(10) NOT NULL,
  `routetype_id` int(10) NOT NULL,
  `routetype_name` varchar(500) CHARACTER SET utf32 COLLATE utf32_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `routetype` (`route_id`, `routetype_id`, `routetype_name`) VALUES
(1, 3, 'กรุงเทพ-ศิลาอาสน์'),
(1, 4, 'ศิลาอาสน์-กรุงเทพ'),
(1, 7, 'กรุงเทพ-เชียงใหม่'),
(1, 8, 'เชียงใหม่-กรุงเทพ'),
(1, 9, ' กรุงเทพ-เชียงใหม่'),
(1, 10, 'เชียงใหม่-กรุงเทพ'),
(1, 13, 'กรุงเทพ-เชียงใหม่'),
(1, 14, 'เชียงใหม่-กรุงเทพ'),
(4, 21, 'กรุงเทพ-อุบลราชธานี'),
(4, 22, 'อุบลราชธานี-กรุงเทพ'),
(4, 23, 'กรุงเทพ-อุบลราชธานี'),
(4, 24, 'อุบลราชธานี-กรุงเทพ'),
(4, 25, 'กรุงเทพ-หนองคาย'),
(4, 26, 'หนองคาย-กรุงเทพ'),
(3, 31, 'กรุงเทพ-ชุมทางหาดใหญ่'),
(3, 32, 'ชุมทางหาดใหญ่-กรุงเทพ'),
(3, 37, 'กรุงเทพ-สุไหงโก-ลก'),
(3, 38, 'สุไหงโก-ลก-กรุงเทพ'),
(3, 39, 'กรุงเทพ-สุราษฎร์ธานี'),
(3, 40, 'ราษฎร์ธานี-กรุงเทพ'),
(3, 41, 'กรุงเทพ-ยะลา'),
(3, 42, 'ยะลา-กรุงเทพ'),
(3, 43, 'กรุงเทพ-สุราษฎร์ธานี'),
(3, 44, 'สุราษฎร์ธานี-กรุงเทพ'),
(1, 51, 'กรุงเทพ-เชียงใหม่'),
(1, 52, 'เชียงใหม่-กรุงเทพ'),
(4, 67, 'กรุงเทพ-อุบลราชธานี'),
(4, 68, 'อุบลราชธานี-กรุงเทพ'),
(4, 71, 'กรุงเทพ-อุบลราชธานี'),
(4, 72, 'อุบลราชธานี-กรุงเทพ'),
(4, 75, 'กรุงเทพ-หนองคาย'),
(4, 76, 'หนองคาย-กรุงเทพ'),
(4, 77, 'กรุงเทพ-หนองคาย'),
(4, 78, 'หนองคาย-กรุงเทพ'),
(3, 83, 'กรุงเทพ-ตรัง'),
(3, 84, 'ตรัง-กรุงเทพ'),
(3, 85, 'กรุงเทพ-นครศรีธรรมราช'),
(3, 86, 'นครศรีธรรมราช-กรุงเทพ'),
(1, 102, 'เชียงใหม่-กรุงเทพ'),
(1, 105, 'กรุงเทพ-ศิลาอาสน์'),
(1, 106, 'ศิลาอาสน์-กรุงเทพ'),
(1, 107, 'กรุงเทพ-เด่นชัย'),
(1, 108, 'เด่นชัย-กรุงเทพ'),
(1, 109, 'กรุงเทพ-เชียงใหม่'),
(1, 111, 'กรุงเทพ-เด่นชัย'),
(1, 112, 'เด่นชัย-กรุงเทพ'),
(4, 133, 'กรุงเทพ-หนองคาย'),
(4, 134, 'หนองคาย-กรุงเทพ'),
(4, 135, 'กรุงเทพ- อุบลราชธานี'),
(4, 136, 'อุบลราชธานี-กรุงเทพ'),
(4, 139, 'กรุงเทพ-อุบลราชธานี'),
(4, 140, 'อุบลราชธานี-กรุงเทพ'),
(4, 141, 'กรุงเทพ- อุบลราชธานี'),
(4, 142, 'อุบลราชธานี-กรุงเทพ'),
(4, 145, 'กรุงเทพ-อุบลราชธานี'),
(4, 146, 'อุบลราชธานี-กรุงเทพ'),
(3, 167, 'กรุงเทพ-กันตัง'),
(3, 168, 'กันตัง-กรุงเทพ  '),
(3, 169, 'กรุงเทพ-ยะลา'),
(3, 170, 'ยะลา-กรุงเทพ'),
(3, 171, 'กรุงเทพ-สุไหงโกลก'),
(3, 172, 'สุไหงโก-ลก-กรุงเทพ'),
(3, 173, 'กรุงเทพ-นครศรีธรรมราช'),
(3, 174, 'นครศรีธรรมราช-กรุงเทพ  '),
(3, 175, 'ชุมทางหาดใหญ่-สุไหงโก-ลก'),
(3, 176, 'สุไหงโก-ลก-ชุมทางหาดใหญ่'),
(1, 201, 'กรุงเทพ-พิษณุโลก'),
(1, 202, 'พิษณุโลก-กรุงเทพ'),
(1, 207, 'กรุงเทพ-นครสวรรค์'),
(1, 208, 'นครสวรรค์-กรุงเทพ\r\n'),
(1, 209, 'กรุงเทพ-บ้านตาคลี'),
(1, 210, 'บ้านตาคลี-กรุงเทพ'),
(1, 211, 'กรุงเทพ-ตะพานหิน'),
(1, 212, 'ตะพานหิน-กรุงเทพ'),
(4, 233, 'กรุงเทพ-สุรินทร์'),
(4, 234, 'สุรินทร์-กรุงเทพ'),
(3, 251, 'ธนบุรี-ประจวบคีรีขันธ์'),
(3, 252, 'ประจวบคีรีขันธ์-ธนบุรี'),
(3, 254, 'หลังสวน-ธนบุรี'),
(3, 255, 'ธนบุรี-หลังสวน'),
(3, 257, 'ธนบุรี-น้ำตก'),
(3, 258, 'น้ำตก-ธนบุรี'),
(3, 259, 'ธนบุรี-น้ำตก'),
(3, 261, 'กรุงเทพ-หัวหิน'),
(3, 262, 'หัวหิน-กรุงเทพ'),
(2, 275, 'กรุงเทพ-อรัญประเทศ'),
(2, 276, 'อรัญประเทศ-กรุงเทพ'),
(2, 277, 'กรุงเทพ-กบินทร์บุรี'),
(2, 278, 'กบินทร์บุรี-กรุงเทพ'),
(2, 279, 'กรุงเทพ-อรัญประเทศ'),
(2, 280, 'อรัญประเทศ-กรุงเทพ'),
(2, 281, 'กรุงเทพ-กบินทร์บุรี'),
(2, 282, 'กบินทร์บุรี-กรุงเทพ'),
(2, 283, 'กรุงเทพ-บ้านพลูตาหลวง'),
(2, 284, 'บ้านพลูตาหลวง-กรุงเทพ'),
(2, 285, 'กรุงเทพ-ชุมทางฉะเชิงเทรา'),
(2, 286, 'ชุมทางฉะเชิงเทรา-กรุงเทพ'),
(1, 301, 'กรุงเทพ-ลพบุรี'),
(1, 302, 'ลพบุรี-กรุงเทพ'),
(1, 303, 'กรุงเทพ-ลพบุรี'),
(1, 304, 'ลพบุรี-กรุงเทพ'),
(1, 311, 'กรุงเทพ-รังสิต'),
(1, 313, 'กรุงเทพ-ชุมทางบ้านภาชี'),
(1, 314, 'ชุมทางบ้านภาชี-กรุงเทพ'),
(1, 317, 'กรุงเทพ-ลพบุรี'),
(1, 318, 'ลพบุรี-กรุงเทพ'),
(4, 339, 'กรุงเทพ-ชุมทางแก่งคอย'),
(4, 340, 'ชุมทางแก่งคอย-กรุงเทพ'),
(4, 341, 'กรุงเทพ-ชุมทางแก่งคอย'),
(4, 342, 'ชุมทางแก่งคอย-กรุงเทพ'),
(3, 351, 'ธนบุรี-ราชบุรี'),
(3, 352, 'ราชบุรี-ธนบุรี'),
(3, 355, 'กรุงเทพ-สุพรรณบุรี'),
(3, 356, 'สุพรรณบุรี-กรุงเทพ'),
(2, 367, 'กรุงเทพ-ชุมทางฉะเชิงเทรา'),
(2, 368, 'ชุมทางฉะเชิงเทรา-กรุงเทพ'),
(2, 371, 'กรุงเทพ-ปราจีนบุรี'),
(2, 372, 'ปราจีนบุรี-กรุงเทพ'),
(2, 376, 'รังสิต-หัวตะเข้'),
(2, 378, 'หัวตะเข้-กรุงเทพ'),
(2, 379, 'มักกะสัน-หัวตะเข้'),
(2, 380, 'หัวตะเข้-กรุงเทพ'),
(2, 383, 'กรุงเทพ-ชุมทางฉะเชิงเทรา'),
(2, 384, 'ชุมทางฉะเชิงเทรา-กรุงเทพ'),
(2, 388, 'ชุมทางฉะเชิงเทรา-กรุงเทพ'),
(2, 389, 'กรุงเทพ-ชุมทางฉะเชิงเทรา'),
(2, 390, 'ชุมทางฉะเชิงเทรา-กรุงเทพ'),
(2, 391, 'กรุงเทพ-ชุมทางฉะเชิงเทรา'),
(1, 401, 'ลพบุรี-พิษณุโลก'),
(1, 402, 'พิษณุโลก-ลพบุรี'),
(1, 403, 'พิษณุโลก-ศิลาอาสน์'),
(1, 407, 'นครสวรรค์-เชียงใหม่'),
(1, 408, 'เชียงใหม่-นครสวรรค์'),
(1, 409, 'อยุธยา-ลพบุรี'),
(1, 410, 'ศิลาอาสน์-พิษณุโลก'),
(4, 415, 'นครราชสีมา-หนองคาย'),
(4, 416, 'อุดรธานี-นครราชสีมา'),
(4, 417, 'นครราชสีมา-อุดรธานี'),
(4, 418, 'หนองคาย-นครราชสีมา'),
(4, 419, 'นครราชสีมา-อุบลราชธานี'),
(4, 420, 'อุบลราชธานี-ลำชี'),
(4, 421, 'นครราชสีมา-อุบลราชธานี'),
(4, 422, 'อุบลราชธานี-ลำชี'),
(4, 423, 'ลำชี-สำโรงทาบ'),
(4, 424, 'สำโรงทาบ-นครราชสีมา'),
(4, 425, 'ลำชี-อุบลราชธานี'),
(4, 426, 'อุบลราชธานี-นครราชสีมา'),
(4, 427, 'นครราชสีมา-อุบลราชธานี'),
(4, 428, 'อุบลราชธานี-นครราชสีมา'),
(4, 429, 'นครราชสีมา-ชุมทางบัวใหญ่'),
(4, 430, 'ชุมทางบัวใหญ่-นครราชสีมา'),
(4, 431, 'ชุมทางแก่งคอย-ขอนแก่น	   '),
(4, 432, 'ขอนแก่น-ชุมทางแก่งคอย'),
(4, 433, 'ชุมทางแก่งคอย-ชุมทางบัวใหญ่'),
(4, 434, 'ชุมทางบัวใหญ่-ชุมทางแก่งคอย'),
(4, 437, 'ชุมทางแก่งคอย-ลำนารายณ์'),
(4, 438, 'ลำนารายณ์-ชุมทางแก่งคอย'),
(4, 439, 'ชุมทางแก่งคอย-ชุมทางบัวใหญ่'),
(4, 440, 'ชุมทางบัวใหญ่-ชุมทางแก่งคอย'),
(3, 446, 'ชุมทางหาดใหญ่-ชุมพร'),
(3, 447, 'สุราษฎร์ธานี-สุไหงโก-ลก'),
(3, 448, 'สุไหงโก-ลก-สุราษฎร์ธานี'),
(3, 451, 'นครศรีธรรมราช-สุไหงโก-ลก'),
(3, 452, 'สุไหงโก-ลก-นครศรีธรรมราช'),
(3, 453, 'ยะลา-สุไหงโก-ลก'),
(3, 454, 'สุไหงโก-ลก-ยะลา'),
(3, 456, 'ยะลา-นครศรีธรรมราช'),
(3, 463, 'พัทลุง-สุไหงโก-ลก'),
(3, 464, 'สุไหงโก-ลก-พัทลุง'),
(3, 472, 'ศาลายา- ธนบุรี'),
(3, 485, 'ชุมทางหนองปลาดุก-น้ำตก'),
(3, 486, 'น้ำตก-ชุมทางหนองปลาดุก'),
(3, 490, 'คีรีรัฐนิคม-สุราษฎร์ธานี'),
(3, 948, 'ปาดังเบซาร์-ชุมทางหาดใหญ่'),
(3, 950, 'ปาดังเบซาร์-ชุมทางหาดใหญ่');
...
CREATE TABLE `service` (
  ...
  `service_code` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `service` (`complaint_id`, `service_id`, `service_code`) VALUES
(1, 4, 'สัมภาระ'),
(1, 5, 'อาหารบนขบวนรถ'),
(1, 6, 'ติดต่อ 1690'),
(2, 7, 'ความล่าช้า'),
...
(2, 12, 'อื่นๆ'),
(3, 13, 'การเช่าที่ดิน'),
(3, 14, 'การบุกรุกที่ดิน'),
(4, 15, 'คืนตั๋วโดยสาร'),
(4, 16, 'การซื้อตั๋วผ่านช่องทางต่างๆ'),
(5, 17, 'ความสะอาดสถานี'),
(5, 18, 'ห้องน้ำ'),
(5, 19, 'อื่นๆ'),
(6, 20, 'จุดตัด'),
(6, 21, 'ทาง-ราง'),
(6, 22, 'โครงการระบบรถไฟฟ้าสายสีแดง'),
(6, 23, 'โครงการอื่นๆ'),
(6, 24, 'อื่นๆ'),
(7, 25, 'บนขบวนรถ'),
(7, 26, 'สถานี'),
...
(8, 31, 'เก้าอี้'),
(8, 32, 'ไฟ'),
(8, 33, 'เครื่องปรับอากาศ'),
(8, 34, 'หัวรถจักร');

-- --------------------------------------------------------

--
-- Table structure for table `sugform`
--

CREATE TABLE `sugform` (
  `name_sug` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `idcard_sug` varchar(14) COLLATE utf8_unicode_ci NOT NULL,
  `address_sug` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `province_sug` int(10) NOT NULL,
  `districts_sug` int(10) NOT NULL,
  `amphur_sug` int(10) NOT NULL,
  `tel_sug` int(10) NOT NULL,
  `email_sug` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `detail_sug` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `sugform`
--

INSERT INTO `sugform` (`name_sug`, `idcard_sug`, `address_sug`, `province_sug`, `districts_sug`, `amphur_sug`, `tel_sug`, `email_sug`, `detail_sug`, `sug_id`, `status`, `responsible`) VALUES
('test test', 'test1', 'test', 1, 1, 1, 870792322, 'tong@fsfs.com', 'testest', 1, 0, 1),
('test@test.com', '', '', 5, 563, 84, 0, '', '', 2, 2, 2),
('test@test2.com', '', '', 5, 563, 84, 0, '', '', 3, 2, 0),
('tong ja', '1149900339514', '555', 64, 7837, 868, 870792322, 'tongtong@tongtong', 'tong555            ', 4, 1, 3),
('1111', '111111', '111111111', 36, 5000, 554, 1111111, '111111', '     1111111       ', 5, 1, 0),
('new', '1', 'new', 58, 7307, 810, 1, 'new@new.com', 'new            ', 6, 1, 0),
('มาใมห่', '121212121', '21', 72, 8417, 944, 87070707, '07070@0707.com', 'dsadsadsadsa            ', 7, 1, 0),
('น้น้น', '1149900339514', '31313131', 36, 5000, 554, 870792322, '08707@08080.com', 'dsadsa            ', 8, 1, 0),
('', '', '', 0, 0, 0, 0, '', '            ', 9, 1, 0);
...
(1, 'ได้รับคำร้องเรียนแล้ว'),
(2, 'รับทราบเรือง'),
(3, 'กำลังดำเนินการจัดการ'),
...
--
-- Indexes for table `admireform`
--
ALTER TABLE `admireform`
  ADD PRIMARY KEY (`admire_id`);
...
ALTER TABLE `complaintform`
  ADD PRIMARY KEY (`complaintform_id`);
...
--
-- Indexes for table `dagerform`
--
ALTER TABLE `dagerform`
  ADD PRIMARY KEY (`dager_id`);
...
--
-- Indexes for table `routetype`
--
ALTER TABLE `routetype`
  ADD PRIMARY KEY (`routetype_id`);
...
--
-- AUTO_INCREMENT for table `admireform`
--
ALTER TABLE `admireform`
  MODIFY `admire_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `complaintform`
  MODIFY `complaintform_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `dagerform`
--
ALTER TABLE `dagerform`
  MODIFY `dager_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `route`
  MODIFY `route_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `service`
--
ALTER TABLE `service`
  MODIFY `service_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `sugform`
--
ALTER TABLE `sugform`
  MODIFY `sug_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
