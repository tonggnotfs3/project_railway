...
<html lang="en">
  ...
  <body>
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <div class="panel-title">
              <h4><span class="glyphicon glyphicon-phone-alt"  aria-hidden="true"></span>&nbsp;ชื่นชม</h4>
            </div>
          </div>
          <div class="panel-body">
            <form class="form-horizontal" id="dagerform">
    ...
    <script type="text/javascript">
    $(document).ready(function () {
           $('#dagerform').submit(function() {
            var fData = new FormData(document.getElementById("dagerform"));
             $.ajax({
      'type':"POST",
